...
if ($routes['xmadmin']) {
	...
	Route::set('xmadmin', 'dbadmin(/<model>(/<action>(/<id>(/<column_name>))))', array(
		'model' => '[a-zA-Z0-9_]{0,}',
		'action' => '[a-z_]+',
		'id' => '\d+',
		'column_name' => '[a-z_]+')
		...
		'controller' => 'XMAdmin',
		'model' => NULL, // this is the default object that will be displayed when accessing xmadmin (dbadmin) without a model
		'action' => 'index',
		'id' => NULL,
		'column_name' => NULL,
	));
