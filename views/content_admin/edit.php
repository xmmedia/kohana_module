	...
	<div class="row">
		<div class="twelvecol">
			...
			<div class="cl4_buttons"><?php echo Form::submit(NULL, 'Save'),
				Form::input_button(NULL, 'Reset', array('class' => 'cl4_button_link', 'data-cl4_link' => URL::site(Route::get('content_admin')->uri(array('action' => 'edit', 'id' => $content_item->id)) . ($popup ? '?popup=1' : '')))),
				Form::input_button(NULL, 'Cancel', array('class' => 'cl4_button_link content_admin_cancel', 'data-cl4_link' => URL::site(Route::get('content_admin')->uri(array('action' => 'cancel'))))); ?></div>
			<?php echo Form::close(); ?>
		</div>
	</div>
</div>