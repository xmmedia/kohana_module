...
class XM_Airbrake_Notifier {
	...
	/**
	 * @var  string  The version number of the XM Airbrake notifier client submitting the request.
	 */
	 ...
	 */
	protected static $notifier_name = 'xm-airbrake-notifier';

	/**
	 * @var  string  A URL at which more information can be obtained concerning the notifier client.
	 */
	protected static $notifier_url = 'https://github.com/xmmedia/kohana_module';
